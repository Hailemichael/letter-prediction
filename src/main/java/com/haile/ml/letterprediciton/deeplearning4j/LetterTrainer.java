...
public class LetterTrainer {
	...
	private static final Logger logger = LoggerFactory.getLogger(LetterTrainer.class);
	...
	public Integer predictNumber (InputStream is, String modelPath) throws Exception {
		Image tmp = null;
		try {
			tmp = ImageIO.read(is);
		} catch (IOException e) {
